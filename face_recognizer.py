...
data_path = 'C:\\Users\\tronc\\Desktop\\Python\\Data_Face'
image_paths = os.listdir(data_path)
# print('image_paths=', image_paths)
face_recognizer = cv2.face.LBPHFaceRecognizer_create()
# Leyendo el modelo
face_recognizer.read('C:\\Users\\tronc\\Desktop\\Python\\LBPHFFaceModel.xml')


face_classif = cv2.CascadeClassifier('C:\\Users\\tronc\\Desktop\\Python\\haarcascade_frontalface_default.xml')
